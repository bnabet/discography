        ...
        return (
            <Aux>
                <form
                    ...
                    onSubmit={(event) => this.state.editMode
                        ? this.editSong(event)
                        : this.addSong(event)
                    }
                >
                    <label className="form-label">Titre</label>
                    <input type="text" name="title" placeholder="Song title" className="editor-input" onChange={this.onChange} value={this.state.title} required />
                    <div className="editor-group">
                        <div className="editor-subGroup">
                            <label className="form-label">Vitesse</label>
                            <input type="number" name="speed" placeholder="BPM" className="editor-input" onChange={this.onChange} value={this.state.speed} required />
                        </div>
                        <div className="editor-subGroup">
                            <label className="form-label">Gamme</label>
                            <input pattern="^(c|c#|d|d#|e|f|f#|g|g#|a|a#|b|C|C#|D|D#|E|F|F#|G|G#|A|A#|B).*$" type="text" name="range" maxLength="2" placeholder="Gamme" className="editor-input" onChange={this.onChange} value={this.state.range} required />
                        </div>
                    </div>
                    <div className="editor-group">
                        <input type="checkbox" name="categories" value="Trap" onChange={this.onChange} />
                        <label className="form-label checkbox-label">Trap</label>
                    </div>
                    <div className="editor-group">
                        <input type="checkbox" name="categories" value="Old school" onChange={this.onChange} />
                        <label className="form-label checkbox-label">Old school</label>
                    </div>
                    <div className="editor-group">
                        <input type="checkbox" name="categories" value="Others" onChange={this.onChange} />
                        <label className="form-label checkbox-label">Autres</label>
                    </div>
                    <div className="editor-group">
                        <input type="checkbox" name="categories" value="Loops" onChange={this.onChange} />
                        <label className="form-label checkbox-label">Loops</label>
                    </div>
                    <div className="editor-group">
                        <input type="checkbox" name="categories" value="Melodies" onChange={this.onChange} />
                    ...
                    <div className="editor-wrapper">
                        ...
                        <input type="file" min="50" max="200" id="file" onChange={this.selectFile} />
